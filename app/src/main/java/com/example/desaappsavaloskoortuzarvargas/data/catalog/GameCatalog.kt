...
object GameCatalog {
    ...
    private val popularGames = listOf(
        ...
        GameInfo(3, "The Witcher 3: Wild Hunt", "An open world action role-playing game set in a fantasy universe.", listOf("RPG", "Open World", "Action", "Adventure"), listOf("Steam", "Epic Games", "GOG")),
        GameInfo(4, "Cyberpunk 2077", "An open world action-adventure RPG set in the megalopolis of Night City.", listOf("RPG", "FPS", "Open World", "Action"), listOf("Steam", "Epic Games", "GOG")),
        ...
        GameInfo(22, "Persona 5 Royal", "Don the mask and join the Phantom Thieves of Hearts.", listOf("RPG", "Adventure"), listOf("Steam", "GOG")),
        GameInfo(23, "Metaphor: ReFantazio", "A fantasy RPG from the creators of Persona.", listOf("RPG", "Strategy", "Adventure"), listOf("Steam", "GOG")),
        ...
        GameInfo(44, "Control Ultimate Edition", "A supernatural action-adventure game by Remedy.", listOf("Action", "Adventure", "TPS"), listOf("Steam", "Epic Games", "GOG")),
        GameInfo(45, "The Callisto Protocol", "A survival horror game set on Jupiter's moon.", listOf("Horror", "Survival", "Action")),
        GameInfo(46, "Lies of P", "A Soulslike action RPG inspired by Pinocchio.", listOf("Action", "RPG", "Souls-like"), listOf("Steam", "GOG")),
        ...
        GameInfo(53, "Subnautica", "Explore an alien underwater world.", listOf("Survival", "Adventure", "Open World"), listOf("Steam", "Epic Games")),
        ...
        GameInfo(80, "Dead Cells", "A rogue-lite action-platformer.", listOf("Roguelike", "Action", "Platformer", "Indie"), listOf("Steam", "GOG")),
        ...
        GameInfo(88, "Unpacking", "A zen puzzle game about the experience of moving.", listOf("Puzzle", "Indie", "Narrative"), listOf("Steam", "GOG")),
        GameInfo(89, "Spiritfarer", "A cozy management game about dying.", listOf("Adventure", "Simulation", "Indie", "Narrative"), listOf("Steam", "Epic Games", "GOG")),
        ...
        GameInfo(98, "Pillars of Eternity II", "An epic RPG adventuring on the high seas.", listOf("RPG", "Strategy", "Adventure"), listOf("Steam", "GOG")),
